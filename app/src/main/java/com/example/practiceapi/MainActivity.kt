...
import com.example.practiceapi.api.UserAPIService
...
class MainActivity : AppCompatActivity() {
    ...
    fun retrieveUser() {
        ...
        requestUser.enqueue(object: Toast.Callback<User> {
            ...
            override fun onFailure(call: Call<User>, t: Throwable) {
                Toast.makeText(this@MainActivity, "Unable to retrieve data. This may be due to internet connectivity issues.", Toast.LENGTH_LONG).show()
            }
        })
    }
}
